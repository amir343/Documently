...
object Dependencies {
  ...
  object compile {
    ...
    val allDependencies = Seq(akkaActor, akkaTestKit, configrity, scalaz, openNLPTools, openNLPMaxent, commonsIO, commonsCLI,
    slf4jAPI, slf4jSimple, slf4s, rabbitMQ, jerkson)
